...
export default function Header() {
  return (
    <header className="fixed w-full px-4 transition-colors duration-150 border-b border-base-300 bg-base-50 dark:bg-base-900 dark:border-base-700">
      <div className="container max-w-screen-lg">
        <div className="flex items-center pt-4">
          <img src="/icon.png" className="w-8 h-8 dark:filter-invert" alt="Logo" />
        ...
        <div className="px-4 mt-3 -mx-4 overflow-x-auto">
          <nav className="inline-grid grid-flow-col gap-6">
            ...
            <NavLink href="/documents" activeClassName="active">
